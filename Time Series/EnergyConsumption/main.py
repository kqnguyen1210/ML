...
plt.plot(test["Date"], lr_preds, label="Linear Regression", linestyle="--")
plt.plot(test["Date"], rf_preds, label="Random Forest", linestyle="--")
plt.plot(test["Date"], sarima_pred, label="SARIMA", linestyle="--")
plt.xlabel("Date")
plt.ylabel("Consumption")
plt.legend()
plt.show()
